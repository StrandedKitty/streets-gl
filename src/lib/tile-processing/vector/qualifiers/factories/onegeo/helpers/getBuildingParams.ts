...
import getFacadeParamsFromTags
	from "~/lib/tile-processing/vector/qualifiers/factories/onegeo/helpers/getFacadeParams";
import getRoofParams from "~/lib/tile-processing/vector/qualifiers/factories/onegeo/helpers/getRoofParams";
...
export default function getBuildingParams(
	...
	//if (tags.id === 'osm-r3357426') debugger;

	const roofParams = getRoofParams(tags);
	const roofOrientation = getRoofOrientation(<string>tags.orient);
