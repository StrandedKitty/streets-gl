...
export default class GenericInstancedObject extends RenderableObject3D {
	...
	public setInstancesInterleavedBuffer(interleavedBuffer: Float32Array): void {
		...
		this.instanceCount = interleavedBuffer.length / GenericInstancedObject.FloatsPerInstance;
